        ...
        >
          ...
          <div className="relative p-8 sm:p-10 grid sm:grid-cols-[auto_1fr_auto] items-center gap-8">
            ...
            <div className="relative">
              ...
              <div className="relative h-24 w-24 rounded-full bg-gradient-to-br from-accent to-accent-violet ring-2 ring-white/10 grid place-items-center text-3xl font-bold text-canvas-deep">
                D
